...
<div class="box">
  <div class="box-header">
    <h2 class="page-header" style="display: initial;">Laporan Pemain Laki-Laki</h2> <button class="btn btn-primary" style="float: right">Laporan Periode</button>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    <hr>
    <form action="<?php echo site_url('admin/laporan/periode_laki') ?>" method="get">
      <div class="col-md-2">
        <div class="form-group">
          <label>Bulan</label>
          <?= form_dropdown('bulan', bulan_indonesia(), $bulan, 'class="form-control"') ?>
          <center>-</center>
          <?= form_dropdown('bulanAkhir', bulan_indonesia(), $bulanAkhir, 'class="form-control"') ?>
        </div>
      </div>
      <div class="col-md-2">
        <div class="form-group">
